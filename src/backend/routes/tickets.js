...
router.post('/:id/reply', authenticate, authorize('admin', 'residente'), setCommunity, sanitize('message'), upload.single('file'), trackUploadedFile, ticketController.addReply, handleUploadError);
